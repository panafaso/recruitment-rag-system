...
OUTPUT_PER_QUERY = "../data/metrics_hybrid_rrf_bm25plus_bgem3_per_query.csv"
OUTPUT_SUMMARY = "../data/metrics_hybrid_rrf_bm25plus_bgem3_summary.csv"
...
for query_id, group in eval_df.groupby("query_id"):
    ...
    row = {
        "query_id": query_id,
        "system": "Hybrid_RRF_BM25Plus-BGE-M3",
